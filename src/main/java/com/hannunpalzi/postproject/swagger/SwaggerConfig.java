package com.hannunpalzi.postproject.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.hannunpalzi.postproject.controller")) // api 스펙이 작성되어 있는 패키지 (controller)
